...
case $(uname -m) in
    x86_64)
        caddy_url=https://github.com/pmkol/caddy-build/releases/download/caddy/caddy_amd64
        ;;
    aarch64)
        caddy_url=https://github.com/pmkol/caddy-build/releases/download/caddy/caddy_arm64
        ;;
    *) 
